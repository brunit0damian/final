...
def post_lista(request):                       #QuerySet
    ...
    return render(request, 'blog/template/post_lista.html', {'post': posts}) #request es la peticion URL del usuario y entre {} ponemos a mostrar los datos que queremos    
def post_lista2(request):
    return render(request, 'blog/template/post_lista2.html')